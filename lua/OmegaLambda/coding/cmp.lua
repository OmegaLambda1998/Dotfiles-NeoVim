...
-- function OL.callbacks.cmp:add_compat(package, source, o)
--     table.insert(compat.dependencies, package)
--     o.module = "blink.compat.source"
--     OL.callbacks.cmp:add(source, o)
-- end
